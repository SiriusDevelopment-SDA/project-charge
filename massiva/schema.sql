...
-- ----------------------------------------------------------------------------
-- FASE 2 (preview — ainda NÃO usada pelo HTML) — Catálogo de localização
-- Hierarquia: cidade -> bairro -> rua, tudo por empresa.
-- Deixado aqui só para referência do rumo; será finalizado na Fase 2.
-- ----------------------------------------------------------------------------
